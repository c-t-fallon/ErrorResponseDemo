...
var message = "Run the get content tool, what is the very last sentence you see?";
...
[DisplayName("get_content")]
[Description("Gets the content.")]
static async Task<string> GetBookPage()
{
    var page = 1;
    var contents = File.ReadAllText("book-war-and-peace.txt");
    return contents.Substring((page - 1) * 768_000, 768_000);
}
